...
function Ripple(obj)
	spawn(function()
		...
		Ripple.ZIndex = 8
		Ripple.Image = "rbxassetid://131972250302289"--这里输入上传的图片，这个是ui背景图
...
这里是
      ...
      DropShadow.Image = "rbxassetid://131972250302289" --这里是第一次加载出来按键的图片    
    ...
    coroutine.wrap(NPLHKB_fake_script)()
      ...
      Open.MouseButton1Click:Connect(function()
          ...
          Open.Text=Main.Visible and "King.Script    " or "King  "
      end)
]]
...
Open.MouseButton1Click:Connect(function()
  Main.Visible = not Main.Visible
  Open.Image = Main.Visible and "rbxassetid://16060333448" or "rbxassetid://16060333448" --   ص ͼ
end)
...
UIG.Parent = Open
      ...
      function window.Tab(window, name, icon)
        ...
        TabIco.Image = "" or icon and "rbxassetid://16060333448"..icon
...
------------------------------------------------------AL.King    -------------------------------------------------------
    ...
    sound.SoundId = "rbxassetid://6797864253" --    id
